...
class Seq2seqAttention(Analyzer):
    ...
    def learning(self, windows, labels, config, permute_truncated=True, epochs=30):
        ...
        history = self.model.fit(X_in_before_fit, X_out[:, :, :1], validation_split=0.2, epochs=epochs, verbose=2, batch_size=100)
